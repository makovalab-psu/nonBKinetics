...
run <- function(directory, control_directory, filenames, paired=TRUE, ITER=1000, parametric=TRUE) {
  ...
  for (i in c("TOTAL", "MISMATCHES", "INSERTION", "DELETION")) {
    ...
    for (file in filenames) {
      ...
      #load empty windows
      emptyFile <- gsub("FeatureOnly.mf.collapsed", ".collapsed", basename(file))
      emptyFile <- gsub(".collapsed", "EmptyTmp.collapsed", emptyFile)
      ...
      if (length(valuesEmpty) > 0) { #NON-EMPTY CONTROLS
        if (paired == TRUE) {
          #PAIRED DATA
          ...
          if (comparison == TRUE) {
            ...
            stop("Features and controls have unequal feature lengths. ERROR.")
          }
        } else {
          #SINGLE CONTROL
      ...
      tmp_data[gsub("ERRORS", "", gsub(".mf.txt", "", file))] = round(pv, 5) #save pvalue and plot
  ...
  search_for_motif_name <-function(m) {
    grep(m,names(TOTALpvalue), value=TRUE)  
  }
  ...
  if (length(names)<2) {
    ...
    stop("The number of motifs to be analyzed is too low. Please add more motifs. ERROR.")
  }
  ...
  for (i in c("TOTAL", "MISMATCHES", "INSERTION", "DELETION")) {
    ...
    results_headers <-
      c(
        ...
        "sign",
        "p-value",
        "nonZeros_perc_features",
        "nonZeros_perc_controls"
      )
...
directories <-
  c(
    "/Users/Willou/Documents/Doctoral_Thesis/UntitleProject2017/ReplotFig4/PacBio/Joint",
    "/Users/Willou/Documents/Doctoral_Thesis/UntitleProject2017/ReplotFig4/Illumina/Joint",
    "/Users/Willou/Documents/Doctoral_Thesis/UntitleProject2017/ReplotFig4/Diversity_high/RM",
    "/Users/Willou/Documents/Doctoral_Thesis/UntitleProject2017/ReplotFig4/Divergence/RM",
    "/Users/Willou/Documents/Doctoral_Thesis/UntitleProject2017/ReplotFig4/TCGA/RM"
  )
...
for (directory in directories) {
  ...
  paired <- TRUE 
  ITER <- 1000 # only used if parametric=FALSE
  ...
  for (ii in 1:10) {
    print(ii)
    control_directory<-gsub("$",paste0("_control",ii),directory)
