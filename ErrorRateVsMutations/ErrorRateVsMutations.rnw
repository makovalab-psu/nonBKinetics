This script contains the commands necessary to build table S9 and expand the reported observations

<<>>=
IPDvsPbErrorsvsDiv <- read.table('GQuadPlus_Compo_IPD_PbError_Div_1kG_residuals_FILTERED_CONTROLS_phyloP', header = TRUE)

# Next file was generated with MAF >=5% instead of 1 <= MAF < 5%
UpdateDIVERSITYSNP <- read.table('joint_GQuadPlus_varFiltered_GQuadPlus_RMfiltered.mfFeatureOnly.mf.collapsed.reorder')
UpdateDIVERSITYSNP <- UpdateDIVERSITYSNP$V5
IPDvsPbErrorsvsDiv <- cbind(IPDvsPbErrorsvsDiv, UpdateDIVERSITYSNP)
...
q1 <- quantile(IPDvsPbErrorsvsDiv$UpdateDIVERSITYSNP,probs = c(0.05))
q2 <- quantile(IPDvsPbErrorsvsDiv$UpdateDIVERSITYSNP,probs = c(0.25))
q3 <- quantile(IPDvsPbErrorsvsDiv$UpdateDIVERSITYSNP,probs = c(0.75))
q4 <- quantile(IPDvsPbErrorsvsDiv$UpdateDIVERSITYSNP,probs = c(0.93))
q5 <- quantile(IPDvsPbErrorsvsDiv$UpdateDIVERSITYSNP,probs = c(0.95))
q6 <- quantile(IPDvsPbErrorsvsDiv$UpdateDIVERSITYSNP,probs = c(0.96))
q7 <- quantile(IPDvsPbErrorsvsDiv$UpdateDIVERSITYSNP,probs = c(0.97))
q8 <- quantile(IPDvsPbErrorsvsDiv$UpdateDIVERSITYSNP,probs = c(0.98))

df1 <- IPDvsPbErrorsvsDiv[which(IPDvsPbErrorsvsDiv$UpdateDIVERSITYSNP <= q1),]
df2 <- IPDvsPbErrorsvsDiv[which(IPDvsPbErrorsvsDiv$UpdateDIVERSITYSNP <= q2),]
df3 <- IPDvsPbErrorsvsDiv[which(IPDvsPbErrorsvsDiv$UpdateDIVERSITYSNP >= q3),]
df4 <- IPDvsPbErrorsvsDiv[which(IPDvsPbErrorsvsDiv$UpdateDIVERSITYSNP >= q4),]
df5 <- IPDvsPbErrorsvsDiv[which(IPDvsPbErrorsvsDiv$UpdateDIVERSITYSNP >= q5),]
df6 <- IPDvsPbErrorsvsDiv[which(IPDvsPbErrorsvsDiv$UpdateDIVERSITYSNP >= q6),]
df7 <- IPDvsPbErrorsvsDiv[which(IPDvsPbErrorsvsDiv$UpdateDIVERSITYSNP >= q7),]
df8 <- IPDvsPbErrorsvsDiv[which(IPDvsPbErrorsvsDiv$UpdateDIVERSITYSNP >= q8),]
...
temp <- hist(IPDvsPbErrorsvsDiv$UpdateDIVERSITYSNP, plot = FALSE, breaks = 20) #get histogram data
plot(x = temp$mids, y = log(temp$counts), type = "h", lwd = 10, main = "Diversity", xlab = "Diversity in motifs", ylab = 'log(counts)', axes=FALSE,cex.lab=1.4, xlim = c(0,0.12), ylim=c(0,10))
axis(side=1,lwd=3)
axis(side=2,lwd=3)
